--EXEC PRX2_OPERNEW 'vrosa','anascimento','V'
				...
				ELSE IF @EXEC = 'E'
					BEGIN
						...
						IF NOT EXISTS (
							...
							INSERT INTO CB1020 (CB1_FILIAL, CB1_CODOPE, CB1_NOME, CB1_STATUS, CB1_CODUSR, CB1_INTER, CB1_ACAPSM, CB1_INVPVC, CB1_ALDTHR, CB1_ATVCON, CB1_IMPRES, R_E_C_N_O_, R_E_C_D_E_L_) VALUES (@FILIAL, REPLICATE('0', 3) + CONVERT(VARCHAR,@CODOPER + 1), UPPER(@USR), '1', @CODUSR, '0', '1', '1', '2', '1', @IMPRESS, @RECNO+@CONT, 0)
							--SELECT @FILIAL AS FILIAL, REPLICATE('0', 3) + CONVERT(VARCHAR,@CODOPER + 1) AS CODOPERADOR, UPPER(@USR) AS USUARIO, @CODUSR AS CODUSR, @IMPRESS AS IMPRESSORA, @RECNO+@CONT AS RECNO
							SET @CONT = @CONT + 1
